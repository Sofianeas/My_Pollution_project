...
df_ARIEGE= df[df['nom_dept'] == 'ARIEGE']
df_ARIEGE.head()
# %%
# Load the weather data
weather_file_path = 'C:/Users/SCD-UM/OneDrive/Bureau/Project/Projet_Groupe_Pollution_Air_Occitanie/Ariege_meteo.csv'
...
df_ARIEGE['date_debut'] = pd.to_datetime(df_ARIEGE['date_debut'], utc=True)
...
df_ARIEGE['date_debut'] = df_ARIEGE['date_debut'].dt.tz_localize(None)
weather_data['Date'] = weather_data['Date'].dt.tz_localize(None)

# Set 'date_debut' and 'Date' as the indices
df_ARIEGE.set_index('date_debut', inplace=True)
weather_data.set_index('Date', inplace=True)

# Merge the datasets
combined_data = pd.merge(df_ARIEGE, weather_data, left_index=True, right_index=True, how='inner')
...
if isinstance(df_ARIEGE.index, pd.DatetimeIndex):
    df_ARIEGE = df_ARIEGE.reset_index()
...
combined_data = pd.merge(df_ARIEGE, weather_data, left_on='date_debut', right_index=True, how='inner')
...
create_interactive_dual_axis_plot(sub_dataframe['date_debut'], sub_dataframe['Température'], sub_dataframe['valeur'],
                                  ...
                                  'ARIEGE_Temperature_vs_Pollution_Levels')
...
create_interactive_dual_axis_plot(sub_dataframe['date_debut'], sub_dataframe['Humidité'], sub_dataframe['valeur'],
                                  ...
                                  'ARIEGE_Humidity_vs_Pollution_Levels')
...
create_interactive_dual_axis_plot(sub_dataframe['date_debut'], sub_dataframe['Vitesse du vent moyen 10 mn'], sub_dataframe['valeur'],
                                  ...
                                  'ARIEGE_Wind_Speed_vs_Pollution_Levels')
# %%
# Correlation study : 
...
# Display the figure
fig.show()
fig.write_html('C:/Users/SCD-UM/OneDrive/Bureau/Project/Projet_Groupe_Pollution_Air_Occitanie/docs/ARIEGE_pie_chart.html',full_html=False, include_plotlyjs='cdn')
...
# Display the figure
fig.show()
fig.write_html('C:/Users/SCD-UM/OneDrive/Bureau/Project/Projet_Groupe_Pollution_Air_Occitanie/docs/ARIEGE_bar_chart.html',full_html=False, include_plotlyjs='cdn')
# %%

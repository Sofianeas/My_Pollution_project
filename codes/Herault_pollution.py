...
output_file_path = 'C:/Users/SCD-UM/OneDrive/Bureau/My_Pollution_project/codes/df_HERAULT.csv'
...
df_HERAULT['date_debut'] = pd.to_datetime(df_HERAULT['date_debut'], utc=True)
...
df_HERAULT['date_debut'] = df_HERAULT['date_debut'].dt.tz_localize(None)
...
fig.update_layout(
    title="Concentration maximale de pollution à l'Hérault par mois",
    xaxis_title="Mois",

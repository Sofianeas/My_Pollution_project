...
df_TARBES = df[df['nom_com'] == 'TARBES']
...
weather_file_path = 'C:/Users/SCD-UM/OneDrive/Bureau/My_Pollution_project/codes/Tarbes_meteo.csv'
...
df_TARBES['date_debut'] = pd.to_datetime(df_TARBES['date_debut'], utc=True)
...
df_TARBES['date_debut'] = df_TARBES['date_debut'].dt.tz_localize(None)
weather_data['Date'] = weather_data['Date'].dt.tz_localize(None)

# Set 'date_debut' and 'Date' as the indices
df_TARBES.set_index('date_debut', inplace=True)
weather_data.set_index('Date', inplace=True)

# Merge the datasets
combined_data = pd.merge(df_TARBES, weather_data, left_index=True, right_index=True, how='inner')
...
if isinstance(df_TARBES.index, pd.DatetimeIndex):
    df_HERAULT = df_TARBES.reset_index()
...
combined_data = pd.merge(df_TARBES, weather_data, left_on='date_debut', right_index=True, how='inner')
#%%
...
create_interactive_dual_axis_plot(sub_dataframe['date_debut'], sub_dataframe['Température'], sub_dataframe['valeur'],
                                  ...
                                  'Tarbes_Temperature_vs_Pollution_Levels')
...
create_interactive_dual_axis_plot(sub_dataframe['date_debut'], sub_dataframe['Humidité'], sub_dataframe['valeur'],
                                  ...
                                  'Tarbes_Humidity_vs_Pollution_Levels')
...
create_interactive_dual_axis_plot(sub_dataframe['date_debut'], sub_dataframe['Vitesse du vent moyen 10 mn'], sub_dataframe['valeur'],
                                  ...
                                  'Tarbes_Wind_Speed_vs_Pollution_Levels')
# %%
# Correlation study : 
...
pie_chart = px.pie(pollutant_concentration, names='nom_poll', values='valeur', 
                   title="Répartition des concentrations de pollution à Tarbes")
...
# Display the figure
pie_chart.show()
pie_chart.write_html('C:/Users/SCD-UM/OneDrive/Bureau/My_Pollution_project/docs/Tarbes_pie_chart.html',full_html=False, include_plotlyjs='cdn')
# %%
...
fig.update_layout(
    title="Concentration maximale de pollution à Tarbes par mois",
    xaxis_title="Mois",
...
# Display the figure
fig.show()
fig.write_html('C:/Users/SCD-UM/OneDrive/Bureau/My_Pollution_project/docs/Tarbes_bar_chart.html',full_html=False, include_plotlyjs='cdn')
# %%
